...
namespace Mirror.Runtime.Client
{
...
#endif
    {
        ...
        /// <param name="transport">The transport we want to use for this client.</param>
#if NETSTANDARD
        ...
        public UniTask SendAsync<T>(T message, byte channelId = (byte) Channels.Reliable)
        {
            return Connection.SendAsync(message, channelId);
        }

        public void Send<T>(T message, byte channelId = (byte) Channels.Reliable)
        {
