...
namespace Mirror
{
    ...
    public class NetworkConnection : INetworkConnection
    {
        ...
        /// <returns></returns>
        public virtual void Send<T>(T msg, byte channelId = (byte) Channels.Reliable)
        {
        ...
        public UniTask SendAsync(ArraySegment<byte> segment, byte channelId = (byte) Channels.Reliable)
        {
